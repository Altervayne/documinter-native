...
export const translations = {
   en: {
      ...
      formatLink:           'Link',
      formatFontColor:      'Font color (coming soon)',
      formatHighlightColor: 'Highlight color (coming soon)',
      // Link panel
      linkPanelUrl:             'URL',
   ...
   fr: {
      ...
      formatLink:           'Lien',
      formatFontColor:      'Couleur de police (bientôt disponible)',
      formatHighlightColor: 'Couleur de surbrillance (bientôt disponible)',
      // Link panel
      linkPanelUrl:             'URL',
