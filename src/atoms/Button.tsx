   ...
   return (
      <button
         ...
         className={clsx(
            ...
            size === 'icon' && 'p-1.5',
            variant === 'default' && 'bg-el border-border text-text hover:bg-accent/10',
            variant === 'primary' && 'bg-accent border-accent text-on-accent font-semibold hover:brightness-110',
            variant === 'ghost'   && 'bg-transparent border-transparent text-muted hover:text-text hover:bg-accent/10',
